...
const verticalStepVariants = cva(
  [
    ...
    'data-[completed=true]:[&:not(:last-child)]:after:dark:bg-zinc-900 data-[completed=true]:[&:not(:last-child)]:after:bg-zinc-200',
    'data-[invalid=true]:[&:not(:last-child)]:after:bg-red-500'
  ],
  {
    variants: {
      variant: {
        circle: cn(
          ...
          "[&:not(:last-child)]:after:content-[''] [&:not(:last-child)]:after:w-[2px] [&:not(:last-child)]:after:bg-zinc-200 [&:not(:last-child)]:after:dark:bg-zinc-800",
    ...
    return (
      <div
        ...
        className={cn(
          ...
          '[&:not(:last-child)]:after:transition-all [&:not(:last-child)]:after:duration-200',
          "[&:not(:last-child)]:after:content-[''] [&:not(:last-child)]:after:h-[2px] [&:not(:last-child)]:after:bg-zinc-200 [&:not(:last-child)]:after:dark:bg-zinc-800",
          'data-[completed=true]:[&:not(:last-child)]:after:dark:bg-zinc-900 data-[completed=true]:[&:not(:last-child)]:after:bg-zinc-300',
          'data-[invalid=true]:[&:not(:last-child)]:after:bg-red-500',
          variant === 'circle-alt' &&
          ...
          variant === 'line' &&
            'flex-col flex-1 border-t-[3px] data-[active=true]:border-zinc-200 data-[active=true]:dark:border-zinc-800',
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'data-[active=true]:dark:bg-zinc-900 data-[active=true]:border-zinc-200 data-[active=true]:dark:border-zinc-800 data-[active=true]:text-zinc-900 data-[active=true]:dark:text-zinc-50 data-[active=true]:bg-zinc-100',
        'data-[current=true]:dark:border-zinc-900 data-[current=true]:border-zinc-200 data-[current=true]:bg-',
        'data-[invalid=true]:bg-red-500 data-[invalid=true]:border-red-600 data-[invalid=true]:text-zinc-50',
